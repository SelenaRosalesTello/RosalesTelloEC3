...
public class HomeFragment extends Fragment {
    ...
    private List<Principal> getData(){
        ...
        shows.add(new Entradas("Ensalada Mixta","https://cocina-casera.com/wp-content/uploads/2011/12/ensalada-mixta-receta.jpg",""));
        shows.add(new Entradas("Causa ","https://images-gmi-pmc.edge-generalmills.com/1fdf2172-1313-49e0-b964-9c2cbb484672.jpg",""));
        shows.add(new Entradas("Arroz con leche","https://iperu.pe/wp-content/uploads/2019/12/arroz-con-leche_800x534.jpg",""));
        shows.add(new Entradas("Cusa de langostino","https://kasani.pe/wp-content/uploads/2020/10/CAUSA-DE-LANGOSTINOS-500x370.jpg",""));
        shows.add(new Entradas("Tequeños","https://jameaperu.com/wp-content/uploads/2019/04/teque%C3%B1os_700x467.jpg",""));
        return shows;
    }
